      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div className="space-y-8">
          ...
          <p className="text-secondary md:w-2/3">
            I&apos;m always open to discussing new projects, creative ideas, or opprtunities to be
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <Link
                  href="mailto:T.Sorisa@gmail.com"
        ...
        <div className="bg-white dark:bg-dark/50 p-6 rounded-lg shadow-md">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {status === "success" && (
              <p className="text-green-500 text-center">Message sent sucessfully. Thank you!</p>
            )}

            {status === "error" && (
              <p className="text-red-500 text-center">Message failed to send. Please try again.</p>
            )}
          </form>
        </div>
      </div>
